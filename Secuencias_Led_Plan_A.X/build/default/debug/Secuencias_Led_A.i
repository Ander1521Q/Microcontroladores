...
# 23 "Secuencias_Led_A.asm" 2
 ...
 BSF TRISE, 0 ; Configura ((PORTE) and 0FFh), 0, a como entrada
 BCF TRISE, 1 ; Configura ((PORTE) and 0FFh), 1, a como salida
 BCF TRISE, 2 ; Configura ((PORTE) and 0FFh), 2, a como salida
 ...
 BTFSS PORTE, 0 ; Revisa el boton en ((PORTE) and 0FFh), 0, a
 ...
 RETURN ;Regresa donde quedo la ejecucion
    ...
    Letra_H:
 ; --- FILA 1:01010
 BCF LATA, 0 ;apagado ((PORTA) and 0FFh), 0, a
 BSF LATA, 1 ;Encendido ((PORTA) and 0FFh), 1, a
 BCF LATA, 2
 BSF LATA, 3
 BCF LATA, 4
 ; --- FILA 2:01010
